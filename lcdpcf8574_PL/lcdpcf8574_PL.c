...
//z CP1250 na 0-8
    switch (c)
      {
        case WIN1250_a : c=LCD_a; break;
        case WIN1250_c : c=LCD_c; break;
        case WIN1250_e : c=LCD_e; break;
        case WIN1250_l : c=LCD_l; break;
        case WIN1250_n : c=LCD_n; break;
        case WIN1250_o : c=LCD_o; break;
        case WIN1250_s : c=LCD_s; break;
        case WIN1250_z : c=LCD_z; break;
      }
...
void lcd_init(uint8_t dispAttr)
{
    ...
    lcd_PL_ini();//polskie znaki
}/* lcd_init */

void lcd_defchar(const char *s){
	uint8_t l;
	lcd_write(0x40,0);
	for(l=0;l<64;l++)
		{
	    	//LCD_send_1(pgm_read_byte(s++));
	    	lcd_write(pgm_read_byte(s++),1);
		}
	lcd_write(0x80,0);

}

//tablica 8 polskich znakó
//tylko tyle mo¿na zdefiniowaæ
//zwi¹zane jest to z pojemnoci¹ pamiêci wywietlacza
...
void lcd_PL_ini(void){
	lcd_defchar(__PLchars);
}
