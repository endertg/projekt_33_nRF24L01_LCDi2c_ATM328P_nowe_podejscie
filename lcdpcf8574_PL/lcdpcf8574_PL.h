...
/**
 @brief    Send integer to LCD controller

 @param    integer to send to LCD controller
 @return   none
*/
extern void lcd_int(uint16_t data);

extern void lcd_PL_ini(void);

/**
 @brief macros for automatically storing string constant in program memory
*/

extern void lcd_defchar(const char *s);

#define lcd_puts_P(__s)         lcd_puts_p(PSTR(__s))


/**
 Definicja polskiego znaków
*/
#define LCD_a		0x00
#define LCD_c		0x01
#define LCD_e		0x02
...
/**
 Kod polskich znaków w std. WIN1250
*/
